...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/28 17:17:04 by hbadr             #+#    #+#             */
/*   Updated: 2022/11/28 17:17:08 by hbadr            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << KGREEN << "ScavTrap :" << this->name << " attacks " << target << " causing " << this->attack_damage << " points of damage !\n";
    this->energy_pt -= 1;
}
