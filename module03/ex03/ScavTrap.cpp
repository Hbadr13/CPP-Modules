...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/28 17:18:55 by hbadr             #+#    #+#             */
/*   Updated: 2022/11/28 17:18:57 by hbadr            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap()
{
    std::cout << KGREEN << "ScavTrap : " << KNORMAL << "Default constructor called\n";
}
...
{
    std::cout << KGREEN << "ScavTrap :" << KNORMAL << this->name << " causing " << this->attack_damage << " points of damage !\n";
    this->energy_pt -= 1;
}
