...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/28 17:18:12 by hbadr             #+#    #+#             */
/*   Updated: 2022/11/28 17:18:13 by hbadr            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << KYELLOW << "ClapTrap : " << KNORMAL << this->name << " causing " << this->attack_damage << " points of damage !\n";
    this->energy_pt -= 1;
}
